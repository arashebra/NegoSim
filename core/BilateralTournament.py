...
class BilateralTournament:
    ...
    def __init__(self, protocol_name: str, analysis_man_name: str, Tournament_analysis_name: str ,deadline,
        ...
        self.tournamentanalysis_man = CreateObjectByPath.get_object(ANALYSIS_TOURNAMENT_PACKAGE_NAME,
                                                                    Tournament_analysis_name,agent_names)
                ...
                for party1_name in self.__agent_names:
                    for party2_name in self.__opponent_names:
                        if party1_name != party2_name:
                            ...
                            self.tournamentanalysis_man.add_session_analysis_data(bilateral_session.get_analysis_man().get_analysis_data())

        print(self.tournamentanalysis_man.get_tournament_analysis_data())
        self.tournamentanalysis_man.save_analysis_data()
